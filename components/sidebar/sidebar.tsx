...
export const Sidebar: FC<SidebarProps> = ({ contentType, showSidebar }) => {
  ...
  const teamFolders = folders.filter(folder => folder.type === "teams")
  ...
  return (
    ...
    >
      <div className="bg-base-300 flex h-full flex-col p-3">
        <div className="border-base-100 flex items-center border-b pb-2">
          <WorkspaceSwitcher />
        ...
        {(() => {
          switch (contentType) {
            ...
            case "teams":
              return renderSidebarContent("teams", teams, teamFolders)
